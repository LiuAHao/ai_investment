...
import agent.data_agent as data_agent_module
...
def test_fallback_when_primary_source_raises(monkeypatch):
    ...
    monkeypatch.setattr(data_agent_module, "get_stock_zh_a_hist", mock_hist_raise)
    monkeypatch.setattr(data_agent_module, "get_stock_zh_a_hist_tx", mock_hist_tx)
    monkeypatch.setattr(data_agent_module, "get_stock_zh_a_daily", mock_daily)

    agent = DataAgent(default_start_date="20260101", default_end_date="20260212")
...
def test_fallback_to_third_source_when_first_two_empty(monkeypatch):
    ...
    monkeypatch.setattr(data_agent_module, "get_stock_zh_a_hist", mock_hist_empty)
    monkeypatch.setattr(data_agent_module, "get_stock_zh_a_hist_tx", mock_hist_tx_empty)
    monkeypatch.setattr(data_agent_module, "get_stock_zh_a_daily", mock_daily_ok)
