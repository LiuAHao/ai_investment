...
const ProfileView = ({ setViewState }) => (
      ...
      <div className="bg-slate-900/60 backdrop-blur-md rounded-2xl border border-white/10 p-6 shadow-xl">
        <div className="flex items-start gap-6">
          ...
          <div className="flex-1">
            <h2 className="text-2xl font-bold text-white mb-2">张磊</h2>
            <p className="text-slate-400 mb-4">Premium 会员 · 已验证</p>
          ...
          <div className="flex items-center justify-between py-3 border-b border-white/10">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-slate-500">zhang.lei@example.com</p>
              </div>
            </div>
